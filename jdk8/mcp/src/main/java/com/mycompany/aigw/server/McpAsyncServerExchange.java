...
import com.mycompany.aigw.spec.McpSchema.LoggingLevel;
import com.mycompany.aigw.spec.McpSchema.LoggingMessageNotification;
import com.mycompany.aigw.spec.McpServerSession;
...
public class McpAsyncServerExchange {
	...
	private boolean isNotificationForLevelAllowed(LoggingLevel loggingLevel) {
		return loggingLevel.getLevel() >= this.minLoggingLevel.getLevel();
	}
