...
import com.mycompany.aigw.spec.McpSchema.ClientCapabilities;
import com.mycompany.aigw.spec.McpSchema.GetPromptRequest;
import com.mycompany.aigw.spec.McpSchema.GetPromptResult;
import com.mycompany.aigw.spec.McpSchema.ListPromptsResult;
...
public class McpSyncClient implements AutoCloseable {
	...
	/**
	 * Send a resources/read request for a resource.
	...
	/**
	 * Send a resources/list_templates request.
	 * @param cursor the cursor
	...
	/**
	 * Send a resources/subscribe request to set up a subscription for a resource. The
	 * server will be notified of changes to the resource and its children.
	...
	/**
	 * Send a resources/unsubscribe request to tear down a subscription for a resource.
	 * @param unsubscribeRequest the unsubscribe request.
	 */
	 ...
	 * List prompts.
	 * @param cursor the cursor
	 * @return the list prompts result.
	 */
	...
	/**
	 * Set the logging level at which to filter the lowest allowed level of log messages
	 * from clients.
	 * @param loggingLevel the logging level or null to clear it.
	 */
	...
	/**
	 * Sends a completions/complete request to have a model generate a completion given a
	 * prompt.
	 * @param completeRequest the completion request
