...
public class McpClientCommonProperties {
	...
	public static class Toolcallback {
		...
		/**
		 * Constructor for the Toolcallback configuration.
		 * @param enabled A boolean flag indicating whether the tool callback is enabled. If true,
		 * the tool callback is active; otherwise, it is disabled.
		 */
		public Toolcallback(boolean enabled) {
			this.enabled = enabled;
		}

		/**
		 * Returns whether the tool callback is enabled.
		 * @return true if the tool callback is enabled, false otherwise
		 */
		...
		public boolean equals(Object o) {
			...
			Toolcallback that = (Toolcallback) o;
		...
		public String toString() {
			return "Toolcallback[enabled=" + enabled + "]";
		}
	}
