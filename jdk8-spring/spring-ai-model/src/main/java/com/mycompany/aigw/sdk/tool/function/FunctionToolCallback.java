...
package com.mycompany.aigw.sdk.tool.function;
...
public class FunctionToolCallback<I, O> implements ToolCallback {
	...
	public static <I, O> Builder<I, O> builder(String name, Function<I, O> function) {
		...
		return new Builder<>(name, new BiFunction<I, ToolContext, O>() {
			@Override
			public O apply(I request, ToolContext context) {
	...
	public static <O> Builder<Void, O> builder(String name, Supplier<O> supplier) {
		...
		Function<Void, O> function = new Function<Void, O>() {
			@Override
			public O apply(Void input) {
				return supplier.get();
			}
		};
	...
	public static <I> Builder<I, Void> builder(String name, Consumer<I> consumer) {
		...
		Function<I, Void> function = new Function<I, Void>() {
			@Override
	...
	public static final class Builder<I, O> {
		...
		public FunctionToolCallback<I, O> build() {
			...
			DefaultToolDefinition.Builder builder = DefaultToolDefinition.builder()
				.name(this.name);
			...
			if (StringUtils.hasText(this.description)) {
				...
				builder.description(ToolUtils.getToolDescriptionFromName(this.name));
			}
			
			if (StringUtils.hasText(this.inputSchema)) {
				builder.inputSchema(this.inputSchema);
			}
			else {
				builder.inputSchema(JsonSchemaGenerator.generateForType(this.inputType));
			}
