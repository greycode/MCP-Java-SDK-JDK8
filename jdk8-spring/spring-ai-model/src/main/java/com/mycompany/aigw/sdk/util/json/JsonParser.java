...
package com.mycompany.aigw.sdk.util.json;
...
import com.mycompany.aigw.sdk.util.JacksonUtils;
...
public final class JsonParser {
	...
	public static <T> T fromJson(String json, Type type) {
		...
		try {
			...
			throw new IllegalStateException("Conversion from JSON to " + type.toString() + " failed", ex);
		}
	}
	...
	public static <T> T fromJson(String json, TypeReference<T> type) {
		...
		try {
			...
			throw new IllegalStateException("Conversion from JSON to " + type.getType().toString() + " failed", ex);
		}
	}
